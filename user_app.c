...
void UserAppRun(void)
{
    ...
    static u16 u16DurationIndex = 0;
    
    u16 au16Notes[] = {C4, C4, G4, G4, A4, A4, G4, F4, F4, E4, E4, D4, D4, C4,
                    G4, G4, F4, F4, E4, E4, D4, G4, G4, F4, F4, E4, E4, D4};
    
    u16 au16NoteDuration[] = {N4, N4, N4, N4, N4, N4, N2, N4, N4, N4, N4, N4, 
                     N4, N2, N4, N4, N4, N4, N4, N4, N2, N4, N4, N4, N4, N4, N4, N2};
 
    if(au16NoteDuration[u8NoteIndex] <= u16DurationIndex)
    {
        u16DurationIndex = 0;
        
        while(u16DurationIndex < RT)
        {
    ...
    if(au16NoteDuration[u8NoteIndex] > u16DurationIndex)
    {
        InterruptTimerXus(au16Notes[u8NoteIndex], true);
        u16DurationIndex++;
    }
