...
/*!--------------------------------------------------------------------
@fn void TimeXus(u16MicroSec)

@brief Sets Timer0 to count u16MicroSec microseconds

Requires:
- Timer0 configured such that each timer tick is 1 microsecond
- u16MicroSec is the value in microseconds to time from 1 to 65535
...
*/
void TimeXus(u16 u16MicroSec)
{
    /* Disable the timer*/
    T0CON0 &= 0x7F;
    
    /* Preload TMR0H and TMR0L based on u16TimeXus */
    TMR0L = (0xFFFF - u16MicroSec) & 0xFF;
    TMR0H = ((0xFFFF - u16MicroSec) >> 8) & 0xFF;
